    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title">Gestión Usuario</li>

                <li>
                    <a href="<?php echo e(route('GestionUser.index')); ?>" class="waves-effect">
                        <i class="uil-user"></i>
                        <span>Usuarios</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="<?php echo e(route('gestion-rol-permision.index')); ?>" class=" waves-effect">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/VEGA_MODELO/resources/views/layouts/parcial/left-menu.blade.php ENDPATH**/ ?>