    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="<?php echo e(route('GestionUser.index')); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('gestion-rol-permision.index')); ?>">
                        <i data-feather="users"></i>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/VEGA_MODELO/resources/views/layouts/parcial/sidebar.blade.php ENDPATH**/ ?>